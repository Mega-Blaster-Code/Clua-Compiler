...
function _M.rank(t)
    if t.type == "double" then return 4 end
    if t.type == "float" then return 3 end
    if t.type == "int" then
        if t.numeric == NUMERIC_LONGLONG then return 2.3 end
        if t.numeric == NUMERIC_LONG then return 2.2 end
        if t.numeric == NUMERIC_SHORT then return 1.5 end
        return 2
    end
    if t.type == "char" then return 1 end
end
